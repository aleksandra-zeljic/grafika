...
int main() {
    ...
    // --------------------
    GLFWwindow *window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "mesec nebo zvezdice", NULL, NULL);
    if (window == NULL) {
    ...
    vector<std::string> faces =
            {
                    FileSystem::getPath("resources/textures/skybox1/right.jpeg"),
                    FileSystem::getPath("resources/textures/skybox1/left.jpeg"),
                    FileSystem::getPath("resources/textures/skybox1/top.jpeg"),
                    FileSystem::getPath("resources/textures/skybox1/bottom.jpeg"),
                    FileSystem::getPath("resources/textures/skybox1/front.jpeg"),
                    FileSystem::getPath("resources/textures/skybox1/back.jpeg"),
            };
    ...
    pointLight.diffuse = glm::vec3(0.6);
